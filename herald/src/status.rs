...
fn poll_status(client: &DaemonClient) -> StatusSnapshot {
    let omnibus = match client.omnibus_status() {
        ...
        Err(e) => {
            ...
            if matches!(e, chancellor_client::ClientError::Disconnected | chancellor_client::ClientError::Timeout) {
...
fn handle_action<F>(
    ...
    F: FnOnce(&DaemonClient) -> Result<Value, chancellor_client::ClientError>,
{

...
enable_upnp = false
# Home node — the Tower that anchors you to Omninet.
# Default: tower.omnidea.io (the first node on the network).
home_node = "wss://tower.omnidea.io"
[tower]
...
pub fn to_tower_config(daemon_config: &DaemonConfig, data_dir: &Path) -> TowerConfig {
    ...
    TowerConfig {
        ...
        enable_upnp: daemon_config.omnibus.enable_upnp,
        seed_peers,
        public_url,

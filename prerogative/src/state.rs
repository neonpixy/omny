...
use crate::editor_types::EditorSession;
...
// ensure_vault_unlocked removed — Vault now unlocks with the user's
// password in crown.create / crown.unlock handlers (crown_mod.rs).
